...
| `narrow_layout` | Whether verify probes widths below 768 px; defaults to `true`. Set `false` only for a document whose declared type permits a wide-only reading layout. |
